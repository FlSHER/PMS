...
class PackageCreateCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create a PMS extension package.';
    ...
    public function handle()
    {
        ...
        $this->repository->set('description', sprintf('A "%s" package For PMS.', $packageName));
    ...
    protected function initRepository()
    {
        $this->repository = new Repository([
            'name' => 'vendor/name',
            'description' => '✈️The package is a PMS package.',
            'type' => 'library',
            'license' => 'MIT',
            'require' => [
                'php' => '>=7.1.3',
