...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom($this->app->make('path.schedule.views'), 'schedule');

        // Publish public resource.
        $this->publishes([
            $this->app->make('path.schedule.assets') => $this->app->publicPath().'/assets/schedule',
        ], 'schedule-public');
    ...
    protected function bindPathsInContainer()
    {
        foreach ([
            ...
            'path.schedule.assets' => $root.'/assets',
            ...
            'path.schedule.views' => $resources.'/views',
